...
/* NT36672C high-resolution event packets are 111 bytes, unlike the older
 * xaga NT36672E format (108/65 bytes). Keep the checksum window at the common
 * 65-byte header, which matches both the vendor no-flash driver and the
 * protocol used by this TDDI touch controller.
 */
