 ...
 * CONFIG_MTK_DRAMC here, but no such header exists in this tree and
 * nothing in this file references it -- the guarded include is dead
 * code that only breaks the build once MTK_DRAMC is enabled.
 */
