...
/*
 * errno of the most recent cmdq_mbox_create channel request:
 * -EPROBE_DEFER means "GCE not ready yet, retry is meaningful",
 * anything else is a permanent configuration/hw problem.
 */
