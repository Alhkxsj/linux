...
extern int blp933_vbat_to_soc(int vbat_mv);
extern int blp933_soc_to_ocv(int soc_pct);

/* mtk_battery_algo.c */
extern void battery_algo_init(struct mtk_battery *gm);
extern void fgr_update_c_dod(struct mtk_battery *gm);
extern int OCV_to_SOC_c(struct mtk_battery *gm, int _ocv);
extern int OCV_to_DOD_c(struct mtk_battery *gm, int _ocv);
extern int SOC_to_OCV_c(struct mtk_battery *gm, int _soc);
