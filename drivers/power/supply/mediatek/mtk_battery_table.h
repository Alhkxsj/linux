...
int g_Q_MAX[MAX_TABLE][TOTAL_BATTERY_NUMBER] = {
	...
	{ 4900, 4900, 4900, 4900},/*T1*/
	{ 4800, 4800, 4800, 4800},/*T2*/
	{ 4600, 4600, 4600, 4600},/*T3*/
	{ 4500, 4500, 4500, 4500},/*T4*/
	{ 4200, 4200, 4200, 4200},/*T5*/
	{ 4100, 4100, 4100, 4100},/*T6*/
	{ 4000, 4000, 4000, 4000},/*T7*/
	{ 3900, 3900, 3900, 3900},/*T8*/
	{ 3800, 3800, 3800, 3800} /*T9*/
};

int g_Q_MAX_H_CURRENT[MAX_TABLE][TOTAL_BATTERY_NUMBER] = {
	/*bat1,   bat2,   bat3,    bat4*/
	{ 4700, 4700, 4700, 4700},/*T0*/
	{ 4600, 4600, 4600, 4600},/*T1*/
	{ 4500, 4500, 4500, 4500},/*T2*/
	{ 4300, 4300, 4300, 4300},/*T3*/
	{ 4200, 4200, 4200, 4200},/*T4*/
	{ 3900, 3900, 3900, 3900},/*T5*/
	{ 3800, 3800, 3800, 3800},/*T6*/
	{ 3700, 3700, 3700, 3700},/*T7*/
	{ 3600, 3600, 3600, 3600},/*T8*/
	{ 3500, 3500, 3500, 3500} /*T9*/
};
...
#if (BAT_NTC_100 == 1)
/* NCP15WF104F03RC(100K) - OnePlus/OPPO default */
