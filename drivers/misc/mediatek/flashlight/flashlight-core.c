...
/* qqcandy: oplus project-data dependency removed; the aw36515 driver
 * on 21143/22801 uses the default flashlight_id table. */
#ifdef CONFIG_COMPAT
		...
		const char *name, struct flashlight_operations *dev_ops)
{
	...
	int i;
	/* qqcandy (21143/22801): use the default flashlight_id table. */
...
static void flashlight_remove(struct platform_device *dev)
{
	fl_uninit();
