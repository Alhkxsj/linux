...
#define AW36515_PINCTRL_STATE_HWEN_HIGH "hwen_high"
#define AW36515_PINCTRL_STATE_HWEN_LOW  "hwen_low"
/******************************************************************************
...
static int aw36515_set_ctrl(struct v4l2_ctrl *ctrl, enum aw36515_led_id led_no)
{
	...
	rval= regmap_read(flash->regmap, 0x0b, &boost_reg_val);
	pr_info("%s led_no: %d, ID: %d, boost_reg_val: %d", __func__, led_no, ctrl->id, boost_reg_val);
